...
\nSystem message:""")
    ...
    st.markdown('---')
    with st.container(): 
        st.write("Help the developer: [PayPal Donation](https://www.paypal.com/donate/?hosted_button_id=2F444HZGJBNX6)")
        st.image('QR Code PayPal.png', caption='PayPal Donation')                                                
